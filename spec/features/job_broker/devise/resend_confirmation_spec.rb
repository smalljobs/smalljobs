...
feature 'Resend confirmation' do
  ...
  context 'for an already confirmed user' do
    let!(:user) { Fabricate(:job_broker, email: 'rolf@example.com', confirmed: true) }
  ...
  context 'for an unconfirmed user' do
    let!(:user) { Fabricate(:job_broker, email: 'rolf@example.com', confirmed: false, active: false) }
  ...
  context 'for an unconfirmed, active user' do
    let!(:user) { Fabricate(:job_broker, email: 'rolf@example.com', confirmed: false, active: true) }
