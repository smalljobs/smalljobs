...
describe 'broker/dashboards/show.html.haml' do
  it 'contains the link to edit the organization' do
    render
    expect(rendered).to have_link('Organisation bearbeiten', edit_broker_organization_path)
  end
  ...
  it 'contains the link to show all seekers' do
    render
    expect(rendered).to have_link('Alle Jugendlichen anzeigen', broker_seekers_path)
  end
