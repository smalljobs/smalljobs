Smalljobs::Application.routes.draw do
  ...
  devise_for :job_seekers,   controllers: { confirmations: 'confirmations', omniauth_callbacks: 'omniauth_callbacks' }
  devise_for :job_providers, controllers: { confirmations: 'confirmations' }
