class ApiController < ApplicationController
  ...
  def register
    ...
    message_template = seeker.is_adult? ? seeker.organization.welcome_chat_register_above_18_msg : seeker.organization.welcome_chat_register_msg
