...
class ApplicationController < ActionController::Base
  ...
  def set_current_user
    ...
    if current_user.present? and current_user.rc_id.present? and current_user.rc_username.present? and current_user.rc_token.present? and current_user.rc_token != cookies['rc_token']
