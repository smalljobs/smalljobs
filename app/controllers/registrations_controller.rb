class RegistrationsController < Devise::RegistrationsController
  ...
  def configure_permitted_parameters
    devise_parameter_sanitizer.for(:sign_up) do |u|
      u.permit(:username, :password, :password_confirmation, :firstname, :lastname, :street, :place_id, :date_of_birth, :sex, :email, :phone, :mobile, :contact_preference, :contact_availability, :terms, :organization_id, work_category_ids: [])
    end
  end
