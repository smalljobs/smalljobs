class Broker::ProvidersController < InheritedResources::Base
  ...
  def permitted_params
    params.permit(provider: [:id, :username, :password, :password_confirmation, :firstname, :lastname, :street, :zip, :city, :email, :phone, :mobile, :contact_preference, :contact_availability])
  end
